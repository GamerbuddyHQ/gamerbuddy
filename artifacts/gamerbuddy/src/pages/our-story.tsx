      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-4">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(172,181,255,0.15), rgba(142,193,222,0.15))",
          ...
          <h1
            ...
            style={{
              background: "linear-gradient(135deg, #ACB5FF 0%, #ACB5FF 40%, #8EC1DE 100%)",
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(172,181,255,0.04) 0%, rgba(142,193,222,0.04) 100%)",
            borderColor: "rgba(172,181,255,0.20)",
          }}
        >
          {/* Avatar / identity */}
          <div className="flex items-center gap-4">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(172,181,255,0.20), rgba(142,193,222,0.20))",
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-medium">
                Known as{" "}
                <span className="font-bold" style={{ color: "#ACB5FF" }}>
                  Dualshot66
                </span>{" "}
                in the gaming world
              </p>
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(142,193,222,0.05) 0%, rgba(172,181,255,0.05) 100%)",
            borderColor: "rgba(142,193,222,0.20)",
          }}
        >
          <div className="space-y-1">
            <p className="text-xs font-black uppercase tracking-widest" style={{ color: "#8EC1DE" }}>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(172,181,255,0.30)",
              }}
            >
            ...
            <Link
              ...
              style={{ borderColor: "rgba(172,181,255,0.40)", background: "rgba(172,181,255,0.06)" }}
            >
              Join Free
            </Link>
          </div>

      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-4">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(79,158,255,0.15), rgba(56,186,255,0.15))",
          ...
          <h1
            ...
            style={{
              background: "linear-gradient(135deg, #4F9EFF 0%, #4F9EFF 40%, #38BAFF 100%)",
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(79,158,255,0.04) 0%, rgba(56,186,255,0.04) 100%)",
            borderColor: "rgba(79,158,255,0.20)",
          }}
        >
          {/* Avatar / identity */}
          <div className="flex items-center gap-4">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(79,158,255,0.20), rgba(56,186,255,0.20))",
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground font-medium">
                Known as{" "}
                <span className="font-bold" style={{ color: "#4F9EFF" }}>
                  Dualshot66
                </span>{" "}
                in the gaming world
              </p>
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(56,186,255,0.05) 0%, rgba(79,158,255,0.05) 100%)",
            borderColor: "rgba(56,186,255,0.20)",
          }}
        >
          <div className="space-y-1">
            <p className="text-xs font-black uppercase tracking-widest" style={{ color: "#38BAFF" }}>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link
              ...
              style={{ borderColor: "rgba(79,158,255,0.40)", background: "rgba(79,158,255,0.06)" }}
            >
              Join Free
            </Link>
          </div>

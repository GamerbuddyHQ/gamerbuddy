...
function GlowOrb({ className }: { className?: string }) {
  return (
    <div
      ...
      style={{ background: "radial-gradient(circle, rgba(220,206,64,0.18) 0%, transparent 70%)" }}
    />
  );
}
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(220,206,64,1) 1px, transparent 1px), linear-gradient(90deg, rgba(220,206,64,1) 1px, transparent 1px)",
      ...
      <div className="w-full max-w-md lg:max-w-xl relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-flex items-center justify-center mb-5">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(220,206,64,0.25) 0%, rgba(220,206,64,0.15) 100%)",
                border: "1px solid rgba(220,206,64,0.40)",
                boxShadow: "0 0 40px rgba(220,206,64,0.30), inset 0 1px 0 rgba(255,255,255,0.08)",
              }}
            >
            ...
            <div
              ...
              style={{ background: "radial-gradient(circle, rgba(220,206,64,0.5) 0%, transparent 70%)" }}
            />
          </div>

          <h1
            className="text-3xl font-black tracking-tight text-foreground"
            style={{ textShadow: "0 0 30px rgba(220,206,64,0.30)" }}
          >
            Admin Access
          </h1>
        ...
        <div
          ...
          style={{
            ...
            border: "1px solid rgba(220,206,64,0.20)",
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, rgba(220,206,64,0.8), rgba(220,206,64,0.6), transparent)" }}
          />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              style={{
                background: loading
                  ? "rgba(220,206,64,0.50)"
                  : "linear-gradient(135deg, #b5a730 0%, #DCCE40 60%, #b5a730 100%)",
                boxShadow: loading ? "none" : "0 4px 20px rgba(220,206,64,0.40), 0 0 0 1px rgba(220,206,64,0.30)",
              }}
            >
              {loading ? (
                <>

      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-6 space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 shrink-0 flex-wrap sm:flex-nowrap">
                        ...
                        <div className="rounded-xl border px-3 py-2 text-center min-w-[72px]"
                          ...
                          <p className="text-[9px] font-black uppercase tracking-wider" style={{ color: "rgba(168,85,247,0.65)" }}>You Keep</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border px-6 py-6 flex items-center gap-5"
            ...
            <div className="text-5xl font-black tabular-nums leading-none shrink-0" style={{ color: "#a855f7" }}>10%</div>
            <div>
              <p className="text-base font-extrabold uppercase tracking-wide" style={{ color: "#c084fc" }}>You Keep</p>
              <p className="text-xs mt-1 leading-relaxed" style={{ color: "rgba(192,132,252,0.55)" }}>
                Platform fee goes to <strong className="font-mono" style={{ color: "rgba(192,132,252,0.8)" }}>creedx112@okicici</strong> via Razorpay. Same split applies to all tips and bulk sessions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { label: "This Month", value: fmtUSD(d.monthFees),  sub: `🌍 Global: ${fmtUSD(d.global.total)}`,    icon: <CalendarRange className="h-5 w-5" />, color: "#a855f7" },
            ].map((card) => (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: "Total All-Time", value: fmtUSD(d.totalFees),   color: "#a855f7", icon: <DollarSign className="h-4 w-4" /> },
              ...
              <table className="w-full text-xs min-w-[820px]">
                <thead>
                  <tr className="border-b border-border/20 bg-muted/10">
                    ...
                    <th className="text-right px-4 py-3 font-bold uppercase tracking-widest whitespace-nowrap" style={{ color: "rgba(168,85,247,0.7)" }}>You Keep (10%)</th>
                  ...
                  {visibleFees.map((fee, idx) => {
                    ...
                    return (
                      <tr key={fee.id} onClick={() => setModalFee(fee)}
                        ...
                        <td className="px-4 py-3 text-right whitespace-nowrap">
                          <span className="font-bold tabular-nums" style={{ color: "#a855f7" }}>{fmtUSD(fee.amount)}</span>
                        </td>
                ...
                <tfoot>
                  <tr className="border-t-2 border-border/40 bg-muted/30">
                    ...
                    <td className="px-4 py-4 text-right whitespace-nowrap">
                      <div className="text-[9px] uppercase tracking-widest font-bold" style={{ color: "rgba(168,85,247,0.55)" }}>You Keep</div>
                      <div className="text-base font-black tabular-nums" style={{ color: "#a855f7" }}>{fmtUSD(totalKeep)}</div>
                    </td>

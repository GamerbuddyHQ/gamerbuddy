  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div
        ...
        style={{ boxShadow: "0 0 40px rgba(79,158,255,0.06)" }}
      >
        {/* Header strip */}
        ...
        <div className="px-4 sm:px-6 pb-6">
          ...
          <div className="flex items-end gap-4 -mt-8 mb-4">
            <div
              ...
              style={{ background: profile.profilePhotoUrl ? "transparent" : "rgba(79,158,255,0.15)", backdropFilter: "blur(8px)" }}
            >
      ...
      {gamingAccounts.length > 0 && (
        <div
          ...
          style={{ borderColor: "rgba(79,158,255,0.20)", background: "rgba(8,6,18,0.65)" }}
        >
          <div
            className="flex items-center gap-2.5 px-5 py-3.5 border-b"
            style={{ borderColor: "rgba(255,255,255,0.06)", background: "rgba(79,158,255,0.05)" }}
          >
          ...
          <div className="px-5 py-4 flex flex-wrap gap-2">
            {gamingAccounts.map((acc: GamingAccount) => {
              const meta = GAMING_PLATFORM_META[acc.platform] ?? { label: acc.platform, emoji: "🎮", color: "#4F9EFF", bg: "rgba(79,158,255,0.12)", border: "rgba(79,158,255,0.30)" };
      ...
      <div
        className="rounded-2xl overflow-hidden border"
        style={{
          borderColor: profile.bio ? "rgba(79,158,255,0.2)" : "rgba(255,255,255,0.06)",
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: profile.bio ? "rgba(79,158,255,0.05)" : "rgba(255,255,255,0.015)",
          }}
        >
          <FileText
            className="h-3.5 w-3.5 shrink-0"
            style={{ color: profile.bio ? "rgba(79,158,255,0.75)" : "rgba(255,255,255,0.25)" }}
          />
            ...
            <div className="flex flex-col items-center justify-center py-6 gap-2 text-center">
              <div
                ...
                style={{
                  ...
                  border: "1.5px dashed rgba(79,158,255,0.22)",
                }}
              >
                <FileText className="h-4 w-4" style={{ color: "rgba(79,158,255,0.45)" }} />
              </div>

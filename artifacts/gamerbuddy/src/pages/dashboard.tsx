  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 0 24px rgba(172,181,255,0.07)",
      }}
    >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              style={{ background: "linear-gradient(135deg, #ACB5FF, #8090cc)" }}
            >
    ...
    <div className="space-y-8">
      ...
      {pendingReviewSessions.length > 0 && (
        <div
          ...
          style={{
            ...
            background: "linear-gradient(135deg, rgba(234,179,8,0.08), rgba(172,181,255,0.05))",
      ...
      {!user.idVerified && (
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(245,158,11,0.08), rgba(172,181,255,0.06))",

...
const PHASES = [
  ...
  },
  {
    ...
    accent: "#00E5CD",
    bg: "rgba(0,229,205,0.07)",
    border: "rgba(0,229,205,0.22)",
    glow: "rgba(0,229,205,0.12)",
...
const STATUS_STYLES = {
  ...
  next:   { dot: "#00E5CD", pulse: false, label: "Coming Soon" },
    ...
    <div className="max-w-4xl mx-auto space-y-14 pb-16">
      ...
      <div className="text-center space-y-4 pt-2">
        ...
        <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-foreground leading-tight">
          ...
          <span
            style={{
              background: "linear-gradient(135deg, #00E5CD 0%, #00E5CD 100%)",
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(34,197,94,0.06) 0%, rgba(0,229,205,0.04) 100%)",
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(0,229,205,0.10) 0%, rgba(0,229,205,0.06) 100%)",
          borderColor: "rgba(0,229,205,0.28)",
          boxShadow: "0 0 40px rgba(0,229,205,0.10)",
        }}
      >
        ...
        <Link href="/community">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #00E5CD, #00b0a0)",
              color: "#fff",
              boxShadow: "0 4px 20px rgba(0,229,205,0.35)",
            }}
          >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(0,229,205,0.06) 0%, rgba(0,229,205,0.04) 100%)",
          borderColor: "rgba(0,229,205,0.22)",
          boxShadow: "0 0 30px rgba(0,229,205,0.06)",
        }}
      >
        <div className="shrink-0 h-14 w-14 rounded-2xl border flex items-center justify-center"
          style={{ background: "rgba(0,229,205,0.10)", borderColor: "rgba(0,229,205,0.28)" }}>
          <MessageSquare className="h-7 w-7" style={{ color: "#00E5CD" }} />
        </div>

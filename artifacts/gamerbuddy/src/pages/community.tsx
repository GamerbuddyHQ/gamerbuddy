...
const CATEGORY_CONFIG: Record<SuggestionCategory, {
  ...
  feature: { label: "Feature Request", Icon: Zap,         bg: "rgba(255,77,45,0.12)",  border: "rgba(255,77,45,0.40)", color: "#FF4D2D" },
  bug:     { label: "Bug Report",      Icon: Bug,         bg: "rgba(239,68,68,0.10)",   border: "rgba(239,68,68,0.38)",  color: "#f87171" },
  ui:      { label: "UI Improvement",  Icon: Palette,     bg: "rgba(255,77,45,0.10)",  border: "rgba(255,77,45,0.38)", color: "#FF4D2D" },
...
function EmojiPicker({ onPick, onClose }: { onPick: (e: string) => void; onClose: () => void }) {
  ...
  return (
    <div
      ...
      style={{ width: 296, background: "hsl(var(--card))", border: "1px solid rgba(255,77,45,0.35)", boxShadow: "0 8px 40px rgba(255,77,45,0.18), 0 2px 12px rgba(0,0,0,0.5)" }}
    >
      {/* Search bar */}
      <div className="px-2 pt-2 pb-1">
        <input
          ...
          style={{ borderColor: "rgba(255,77,45,0.30)" }}
        />
      </div>
        ...
        <div className="flex px-1 gap-0.5">
          {EMOJI_CATEGORIES.map((cat, i) => (
            <button
              ...
              style={{
                color: tab === i ? "#FF4D2D" : "rgba(148,163,184,0.5)",
                background: tab === i ? "rgba(255,77,45,0.12)" : "transparent",
              }}
            >
              {cat.label}
            </button>
...
function GifPicker({ onPick, onClose }: { onPick: (gif: TenorGif) => void; onClose: () => void }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute bottom-full mb-2 left-0 z-50 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-150"
      style={{ width: 316, background: "hsl(var(--card))", border: "1px solid rgba(255,77,45,0.35)", boxShadow: "0 8px 40px rgba(255,77,45,0.15), 0 2px 12px rgba(0,0,0,0.5)" }}
    >
      {/* Search bar */}
      <div className="p-2 pb-1">
        <div className="relative">
          ...
          <input
            ...
            style={{ border: "1px solid rgba(255,77,45,0.30)" }}
          />
        </div>
      </div>
      ...
      <div className="flex gap-1 px-2 pb-1.5 flex-wrap">
        {GIF_QUICK_TAGS.map((tag) => (
          <button
            ...
            style={{
              background: activeTag === tag ? "rgba(255,77,45,0.22)" : "rgba(255,77,45,0.07)",
              border: `1px solid ${activeTag === tag ? "rgba(255,77,45,0.55)" : "rgba(255,77,45,0.20)"}`,
              color: activeTag === tag ? "#FF4D2D" : "rgba(148,163,184,0.65)",
            }}
          >
            {tag}
          </button>
          ...
          <div className="grid grid-cols-3 gap-1">
            {gifs.map((g) => (
              <button
                ...
                style={{ focusRingColor: "rgba(255,77,45,0.5)" }}
              >
      ...
      {/* Footer */}
      <div className="px-2 py-1 border-t flex items-center justify-end" style={{ borderColor: "rgba(255,77,45,0.10)" }}>
  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        style={{ border: "1px solid rgba(255,77,45,0.35)", background: "rgba(0,0,0,0.3)" }}
      >
        <textarea
          ref={textareaRef}
          value={value}
          ...
          <div className="px-3 pb-2">
            <div className="relative inline-block group">
              <img
                ...
                alt="Selected GIF"
                className="rounded-xl"
                style={{ maxHeight: 110, maxWidth: 200, display: "block", border: "1px solid rgba(255,77,45,0.25)" }}
                loading="lazy"
              />
              {onGifClear && (
                <button
              ...
              <div
                ...
                style={{ background: "rgba(0,0,0,0.7)", color: "rgba(255,77,45,0.9)" }}
              >GIF</div>
            </div>
          </div>
        )}
        ...
        >
          ...
          <div className="relative">
            <button
              ...
              title="Add emoji"
              style={{
                background: showEmoji ? "rgba(255,77,45,0.18)" : "transparent",
          ...
          {onGifSelect && (
            <div className="relative">
              <button
                ...
                title="Add GIF"
                style={{
                  background: showGif ? "rgba(255,77,45,0.18)" : "rgba(255,77,45,0.07)",
                  border: `1px solid ${showGif ? "rgba(255,77,45,0.5)" : "rgba(255,77,45,0.22)"}`,
                  color: showGif ? "#FF4D2D" : "rgba(255,77,45,0.65)",
  ...
  return (
    <div className={depth > 0 ? "pl-4 border-l border-border/25" : ""}>
      {comment.isPinned && depth === 0 && (
        <div className="flex items-center gap-1.5 pt-2.5 pb-0.5 text-[10px] font-semibold" style={{ color: "rgba(255,77,45,0.75)" }}>
      ...
      <div className="flex gap-3 py-3">
        {comment.isAdminComment ? (
          <div
            ...
            style={{ width: 26, height: 26, background: "rgba(255,77,45,0.18)", border: "1px solid rgba(255,77,45,0.35)" }}
          >
            <Shield className="h-3.5 w-3.5" style={{ color: "rgba(255,77,45,0.9)" }} />
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {comment.isAdminComment && (
              <span
                ...
                style={{ background: "rgba(255,77,45,0.18)", color: "rgba(255,77,45,0.9)", border: "1px solid rgba(255,77,45,0.3)" }}
              >
                Official
              </span>
            )}
          ...
          <div className="flex items-center gap-3 mt-1.5">
            ...
            {isAdmin && depth === 0 && (
              <button
                ...
                style={{ color: comment.isPinned ? "rgba(255,77,45,0.8)" : "rgba(255,255,255,0.3)" }}
...
function CommentsPanel({ suggestion }: { suggestion: Suggestion }) {
  ...
  return (
    <div className="border-t px-4 sm:px-5 py-4 space-y-4" style={{ borderColor: "rgba(255,77,45,0.12)", background: "rgba(0,0,0,0.25)" }}>
      {isAdmin && (
        <div
          className="rounded-lg p-3 space-y-2"
          style={{ background: "rgba(255,77,45,0.07)", border: "1px solid rgba(255,77,45,0.25)" }}
        >
          <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider" style={{ color: "rgba(255,77,45,0.8)" }}>
          ...
          <textarea
            ...
            style={{ borderColor: "rgba(255,77,45,0.3)", focusRingColor: "rgba(255,77,45,0.5)" }}
            onKeyDown={(e) => {
          ...
          <div className="flex justify-end">
            <Button
              ...
              style={{ background: "rgba(255,77,45,0.8)" }}
            >
...
function AdminToolbar({ suggestion }: { suggestion: Suggestion }) {
  ...
  return (
    <div
      className="border-t"
      style={{ borderColor: "rgba(255,77,45,0.14)", background: "rgba(8,3,18,0.70)" }}
    >
      {/* ── Header strip ── */}
      <div
        className="flex items-center justify-between gap-3 px-4 py-2.5 border-b flex-wrap"
        style={{ borderColor: "rgba(255,77,45,0.10)", background: "rgba(255,77,45,0.05)" }}
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-4 flex-wrap">
            ...
            <button
              ...
              style={expanded
                ? { background: "rgba(255,77,45,0.14)", border: "1px solid rgba(255,77,45,0.30)", color: "#FF4D2D" }
...
function SubmitForm({ onSuccess }: { onSuccess: () => void }) {
    ...
    return (
      ...
      >
        ...
        <div className="flex gap-3 mt-1">
          ...
          <Button size="sm" className="text-xs" style={{ background: "rgba(255,77,45,0.25)", border: "1px solid rgba(255,77,45,0.40)", color: "#FF4D2D" }} onClick={() => setSubmitted(false)}>
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg,rgba(255,77,45,0.07) 0%,rgba(0,0,0,0.3) 100%)",
        borderColor: "rgba(255,77,45,0.35)",
        boxShadow: "0 0 0 1px rgba(255,77,45,0.08), 0 8px 32px rgba(0,0,0,0.4)",
      }}
    >
      <div className="flex items-center gap-2">
        <div className="h-6 w-6 rounded-lg flex items-center justify-center" style={{ background: "rgba(255,77,45,0.25)", border: "1px solid rgba(255,77,45,0.40)" }}>
      ...
      <div className="space-y-3">
        ...
        <Button
          ...
          style={{ background: "linear-gradient(135deg,#FF4D2D,#cc3a1e)", boxShadow: "0 0 20px rgba(255,77,45,0.3)" }}
        >
...
function AdminQueue({ suggestions, isAdmin }: { suggestions: Suggestion[]; isAdmin: boolean }) {
  ...
  const TABS: { value: "pending" | "hidden" | "spam"; label: string; count: number; dotColor: string }[] = [
    { value: "pending", label: "All Pending", count: totalPending, dotColor: "#FF4D2D" },
  ...
  return (
    <div
      ...
      style={{
        borderColor: totalPending > 0 ? "rgba(255,77,45,0.50)" : "rgba(255,77,45,0.28)",
        background: "rgba(6,3,15,0.90)",
        boxShadow: totalPending > 0
          ? "0 0 40px rgba(255,77,45,0.12), inset 0 1px 0 rgba(255,77,45,0.12)"
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: "linear-gradient(135deg,rgba(255,77,45,0.28),rgba(255,77,45,0.10))", border: "1px solid rgba(255,77,45,0.55)" }}
          >
      ...
      {open && (
        <div className="border-t" style={{ borderColor: "rgba(255,77,45,0.14)" }}>

          {/* ── Stats row ── */}
          <div
            className="grid grid-cols-3"
            style={{ borderBottom: "1px solid rgba(255,77,45,0.12)" }}
          >
            {STATS.map(({ label, count, cfg, desc }, i) => (
              <div
                key={label}
                className="flex flex-col items-center py-4 gap-1.5"
                style={{ borderRight: i < 2 ? "1px solid rgba(255,77,45,0.10)" : "none" }}
              >
                <div className="flex items-center gap-1.5">
          ...
          <div
            ...
            style={{ borderBottom: "1px solid rgba(255,77,45,0.10)", background: "rgba(0,0,0,0.20)" }}
          >
                ...
                >
                  ...
                  {count > 0 && (
                    <span
                      ...
                      style={active
                        ? { background: "rgba(255,77,45,0.30)", color: "#e9d5ff" }
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-5">
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 55% 35% at 30% 15%,rgba(255,77,45,0.10) 0%,transparent 60%)" }}
      />
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <span
            ...
            style={{ background: "rgba(255,77,45,0.12)", border: "1px solid rgba(255,77,45,0.30)", color: "#FF4D2D" }}
          >
            Community
          </span>
        </div>
          ...
          <div className="shrink-0 flex flex-col items-end gap-2">
            {user && !showForm && (
              <Button
                ...
                style={{ background: "linear-gradient(135deg,#FF4D2D,#cc3a1e)", boxShadow: "0 0 18px rgba(255,77,45,0.32)" }}
              >
        ...
        {SORTS.map(({ value, label, Icon }) => {
          ...
          return (
            <button
              ...
              style={active ? {
                background: "linear-gradient(135deg,rgba(255,77,45,0.28),rgba(255,77,45,0.18))",
                border: "1px solid rgba(255,77,45,0.55)",
                color: "#FF4D2D",
                boxShadow: "0 0 16px rgba(255,77,45,0.20)",
              } : {
      ...
      {!isLoading && !isError && visibleSuggestions.length === 0 && (
        <div
          ...
          style={{ borderColor: "rgba(255,77,45,0.15)", background: "rgba(255,77,45,0.03)" }}
        >
          <div className="h-14 w-14 rounded-full flex items-center justify-center" style={{ background: "rgba(255,77,45,0.12)", border: "1px solid rgba(255,77,45,0.25)" }}>
          ...
          {user ? (
            <Button size="sm" onClick={() => setShowForm(true)} style={{ background: "rgba(255,77,45,0.20)", border: "1px solid rgba(255,77,45,0.40)", color: "#FF4D2D" }}>

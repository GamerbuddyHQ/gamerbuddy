...
function ParticleCanvas() {
  ...
  useEffect(() => {
    ...
    const COLORS = ["rgba(255,77,45,", "rgba(255,77,45,", "rgba(255,77,45,", "rgba(255,77,45,"];
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, rgba(255,77,45,0.12) 0%, rgba(255,77,45,0.10) 100%)",
          borderBottom: "1px solid rgba(255,77,45,0.20)",
        }}
      >
        <span
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-4 pt-14 pb-12 lg:pt-24 lg:pb-16 overflow-hidden min-h-[600px] lg:min-h-[720px]">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 110% 90% at 50% -5%, rgba(180,50,25,0.35) 0%, rgba(255,77,45,0.10) 35%, transparent 65%)",
            zIndex: 0,
          }}
        />
        {/* Left orb */}
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(255,77,45,0.15) 0%, transparent 58%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(255,77,45,0.09) 0%, transparent 58%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 70% 55% at 50% 0%, rgba(140,90,46,0.22) 0%, transparent 60%)",
            zIndex: 0,
          }}
        />
        ...
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            backgroundImage: "radial-gradient(circle, rgba(255,77,45,0.12) 1px, transparent 1px)",
        ...
        <div className="relative w-full max-w-5xl mx-auto" style={{ zIndex: 2 }}>
          ...
          <div className="flex justify-center mb-6">
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 24px rgba(255,77,45,0.18), inset 0 1px 0 rgba(255,255,255,0.06)",
              }}
            >
          ...
          <h1 className="font-black tracking-tight leading-[1.02] mb-5">
            ...
            <span
              ...
              style={{
                background: "linear-gradient(135deg, #FF4D2D 0%, #FF4D2D 40%, #cc3a1e 100%)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
                filter: "drop-shadow(0 0 32px rgba(255,77,45,0.60))",
              }}
            >
              {t.home.headline2}
            </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 mb-6">
            <Link href="/signup">
              <button
                ...
                style={{
                  background: "linear-gradient(135deg, #cc3a1e 0%, #cc3a1e 50%, #661a0c 100%)",
                  boxShadow: "0 8px 32px rgba(255,77,45,0.55), 0 2px 8px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.12)",
                  minWidth: "210px",
                }}
              >
                {/* shimmer */}
            ...
            <Link href="/browse">
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(255,77,45,0.45)";
                }}
                onMouseLeave={(e) => {
      ...
      <section className="px-4 py-8 lg:py-12">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(0,150,120,0.08) 0%, rgba(255,77,45,0.05) 100%)",
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, rgba(255,77,45,0.5), rgba(255,77,45,0.3), transparent)" }}
          />
          {/* corner glows */}
          <div
            className="absolute top-0 left-0 w-80 h-80 rounded-full pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(255,77,45,0.10) 0%, transparent 65%)" }}
          />
          <div
            className="absolute bottom-0 right-0 w-64 h-64 rounded-full pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(255,77,45,0.07) 0%, transparent 65%)" }}
          />
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div
              ...
              style={{ background: "linear-gradient(to bottom, transparent, rgba(255,77,45,0.35), rgba(255,77,45,0.20), transparent)" }}
            />
              ...
              <div>
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(255,77,45,0.30)",
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              { icon: <Zap className="h-5 w-5 text-cyan-400" />, label: "Instant Alerts", sub: "Real-time bids, starts, and payments", bg: "rgba(255,77,45,0.08)", border: "rgba(255,77,45,0.20)" },
      ...
      <section className="px-4 pb-20 pt-6">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(70,20,10,0.75) 0%, rgba(140,90,46,0.28) 50%, rgba(140,40,20,0.18) 100%)",
            border: "1px solid rgba(0,200,170,0.28)",
            boxShadow: "0 0 80px rgba(140,90,46,0.18), inset 0 0 60px rgba(0,80,60,0.10)",
          }}
        >
          {/* top glow line */}
          <div
          ...
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(255,77,45,0.18) 0%, transparent 70%)" }}
          />
          <div
            className="absolute bottom-0 left-0 w-56 h-56 rounded-full pointer-events-none"
            style={{ background: "radial-gradient(circle, rgba(255,77,45,0.14) 0%, transparent 70%)" }}
          />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-3">
              <Link href="/signup">
                <button
                  ...
                  style={{
                    background: "linear-gradient(135deg, #FF4D2D 0%, #aa2e16 60%, #882210 100%)",
                    boxShadow: "0 0 32px rgba(255,77,45,0.45), 0 4px 16px rgba(0,0,0,0.30)",
                  }}
                >
                  <div
                    className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 pointer-events-none"

...
function Step({ n, title, desc }: { n: number; title: string; desc: string }) {
  return (
    <div className="flex gap-4 items-start group">
      <div
        className="shrink-0 w-10 h-10 rounded-xl flex items-center justify-center font-black text-sm text-[#0A0E11] transition-all duration-200 group-hover:scale-105"
        style={{
          background: "linear-gradient(135deg, #5DAA1A 0%, #A1FF4F 100%)",
          boxShadow: "0 0 14px rgba(161,255,79,0.40)",
        }}
      >
        {n}
      </div>
    ...
    <div className="overflow-x-hidden">
        ...
        <div className="relative w-full max-w-5xl mx-auto" style={{ zIndex: 2 }}>
          ...
          <h1 className="font-black tracking-tight leading-[1.02] mb-5">
            ...
            <span
              ...
              style={{
                background: "linear-gradient(135deg, #A1FF4F 0%, #A1FF4F 55%, #7DCC2A 100%)",
            ...
            <Link href="/signup">
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 4px 18px rgba(255,59,92,0.45), 0 2px 8px rgba(0,0,0,0.35)",
                  minWidth: "210px",
                }}
              >
                {/* shimmer */}
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <FeatureCard
              ...
              iconBg="bg-[#1A1A1A]"
              iconColor="text-[#A1FF4F]"
              glowColor="rgba(161,255,79,0.75)"
      ...
      <section className="px-4 py-8 lg:py-12">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(161,255,79,0.06) 0%, rgba(161,255,79,0.03) 100%)",
      ...
      <section className="px-4 py-8">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { icon: <Shield className="h-5 w-5 text-[#A1FF4F]" />, label: "Escrow Protected", sub: "Funds held until session complete", bg: "rgba(161,255,79,0.04)", border: "rgba(161,255,79,0.18)" },
              { icon: <Star className="h-5 w-5 text-[#A1FF4F]" />, label: "Verified Reviews", sub: "Both sides must leave a review", bg: "rgba(161,255,79,0.04)", border: "rgba(161,255,79,0.18)" },
              { icon: <Zap className="h-5 w-5 text-[#A1FF4F]" />, label: "Instant Alerts", sub: "Real-time bids, starts, and payments", bg: "rgba(161,255,79,0.04)", border: "rgba(161,255,79,0.18)" },
              { icon: <Trophy className="h-5 w-5 text-[#A1FF4F]" />, label: "Transparent 10% Fee", sub: "Gamers keep 90% — no hidden charges", bg: "rgba(161,255,79,0.04)", border: "rgba(161,255,79,0.18)" },
      ...
      <section className="px-4 pb-20 pt-6">
        ...
        >
          ...
          <div
            className="absolute top-0 left-0 right-0 h-px pointer-events-none"
            style={{ background: "linear-gradient(90deg, transparent, rgba(161,255,79,0.30), transparent)" }}
          />

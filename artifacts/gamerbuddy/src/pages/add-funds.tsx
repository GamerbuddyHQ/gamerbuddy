  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <div
        ...
        style={{ background: "linear-gradient(160deg, #1a0a42 0%, #0a0a1a 100%)", border: "1px solid rgba(0,229,205,0.3)" }}
      >
...
function SuccessScreen({
  ...
  return (
    <div className={`max-w-md mx-auto transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
      ...
      <div className="rounded-2xl overflow-hidden mb-5" style={{ border: "1px solid rgba(0,229,205,0.2)", background: "linear-gradient(160deg, rgba(0,229,205,0.05) 0%, rgba(0,0,0,0.4) 100%)" }}>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <button
          ...
          className="rounded-xl bg-primary py-3.5 font-extrabold text-sm text-white uppercase tracking-wider shadow-[0_0_20px_rgba(0,229,205,0.3)] hover:bg-primary/90 transition-all"
        >
          Post a Request
        </button>
      </div>
  ...
  return (
    <div className="max-w-md mx-auto text-center space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={onRetry}
          className="flex-1 rounded-xl bg-primary py-3.5 font-extrabold text-sm text-white uppercase tracking-wider shadow-[0_0_20px_rgba(0,229,205,0.3)] hover:bg-primary/90 transition-all flex items-center justify-center gap-2"
        >
      ...
      <button
        ...
        className={`w-full relative overflow-hidden rounded-xl py-4 font-extrabold text-base uppercase tracking-widest transition-all ${
          loading
            ...
            : "bg-primary text-white hover:bg-primary/90 shadow-[0_0_28px_rgba(0,229,205,0.4)]"
        }`}
      >
    ...
    <div className="max-w-lg mx-auto space-y-6">
      ...
      {isInternational && (
        <div
          ...
          style={{
            ...
            background: "rgba(0,229,205,0.05)",
          }}
        >
              ...
              <button
                ...
                className={`rounded-xl border py-3.5 px-2 text-center font-bold transition-all text-sm ${
                  disabled
                    ...
                    ? "border-primary bg-primary/20 text-foreground shadow-[0_0_14px_rgba(0,229,205,0.3)]"
      ...
      <button
        ...
        className={`w-full rounded-xl py-4 font-extrabold text-base uppercase tracking-widest transition-all ${
          isValidAmount
            ? "bg-primary text-white hover:bg-primary/90 shadow-[0_0_24px_rgba(0,229,205,0.35)]"

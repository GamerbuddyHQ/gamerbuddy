  ...
  return (
    <div className="flex flex-col border border-secondary/30 rounded-2xl overflow-hidden bg-background/60 shadow-[0_0_20px_rgba(6,182,212,0.08)]">
            ...
            return (
              <div key={msg.id} className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
                <div className={`max-w-[78%] rounded-2xl px-3.5 py-2 text-sm shadow-sm ${
                  isMe
                    ? "bg-primary text-white rounded-br-none shadow-[0_0_12px_rgba(79,158,255,0.3)]"
      ...
      <div className="border-t border-border/60 p-2 flex gap-2 bg-card/50">
        ...
        <Button
          size="sm"
          className="h-9 px-3 bg-primary hover:bg-primary/90 shadow-[0_0_12px_rgba(79,158,255,0.4)]"
          onClick={handleSend}
...
function BulkProgressCard({
  ...
  const barGradient = isFull
    ...
    : pct >= 50
    ? "linear-gradient(90deg, #2060c8 0%, #4F9EFF 40%, #38BAFF 100%)"
    : "linear-gradient(90deg, #2060c8 0%, #4F9EFF 70%, #4F9EFF 100%)";

  const barGlow = isFull
    ? "0 0 20px rgba(34,197,94,0.55), 0 0 50px rgba(34,197,94,0.15)"
    : pct >= 50
    ? "0 0 20px rgba(79,158,255,0.5), 0 0 40px rgba(56,186,255,0.18)"
    : "0 0 16px rgba(79,158,255,0.55), 0 0 40px rgba(79,158,255,0.12)";
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-baseline gap-1.5">
          <span
            ...
            style={{ color: isFull ? "#4ade80" : pct >= 50 ? "#38BAFF" : "#4F9EFF" }}
          >
            {acceptedBidsCount}
          </span>
                  ...
                  style={{
                    background: filled
                      ? isFull
                        ...
                        ? "linear-gradient(180deg, #38BAFF, #4F9EFF)"
                        : "linear-gradient(180deg, #4F9EFF, #2060c8)"
                      : "rgba(255,255,255,0.05)",
                    boxShadow: filled ? (isFull ? "0 0 6px rgba(74,222,128,0.5)" : "0 0 6px rgba(79,158,255,0.4)") : "none",
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center p-4 pointer-events-none">
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 50px rgba(79,158,255,0.3), 0 25px 60px rgba(0,0,0,0.6)",
        }}
      >
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <Button
            ...
            style={{
              background: "linear-gradient(135deg, #2060c8 0%, #4F9EFF 100%)",
              boxShadow: "0 0 20px rgba(79,158,255,0.5)",
            }}
            onClick={onAccept}
    ...
    <>
      ...
      <div
        className={`group rounded-2xl border overflow-hidden transition-all duration-300 ${
          ...
          isSelected                  ? "border-purple-500/65 shadow-[0_0_32px_rgba(79,158,255,0.18)]" :
          ...
          "border-border/60 hover:border-primary/30 hover:shadow-[0_0_24px_rgba(79,158,255,0.08)]"
        }`}
        style={{
          background: isAccepted        ? "linear-gradient(135deg,rgba(34,197,94,0.05) 0%,rgba(0,0,0,0.55) 100%)" :
                      isSelected        ? "linear-gradient(135deg,rgba(79,158,255,0.07) 0%,rgba(0,0,0,0.55) 100%)" :
        ...
        <div
          ...
          style={{
            background: isAccepted
              ...
              : isMe
              ? "linear-gradient(90deg,transparent 0%,#38BAFF 40%,#38BAFF 60%,transparent 100%)"
              : "linear-gradient(90deg,transparent 0%,#4F9EFF 40%,#4F9EFF 60%,transparent 100%)",
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            {showCheckbox && (
              <button
                ...
                className={`h-5 w-5 rounded-[5px] border-2 flex-shrink-0 flex items-center justify-center transition-all mt-3 ${
                  isSelected
                    ? "bg-purple-500 border-purple-500 shadow-[0_0_8px_rgba(79,158,255,0.6)]"
            ...
            <div
              ...
              style={{
                background: isAccepted ? "rgba(34,197,94,0.15)" : isMe ? "rgba(56,186,255,0.15)" : "rgba(79,158,255,0.15)",
                border: `1.5px solid ${isAccepted ? "rgba(34,197,94,0.35)" : isMe ? "rgba(56,186,255,0.35)" : "rgba(79,158,255,0.35)"}`,
                color: isAccepted ? "#4ade80" : isMe ? "#38BAFF" : "#4F9EFF",
              }}
            >
          ...
          <div
            ...
            style={{
              ...
              background: "linear-gradient(135deg,rgba(79,158,255,0.04) 0%,rgba(0,0,0,0.15) 100%)",
            }}
          >
          ...
          {bid.bidderBio && (
            <div
              ...
              style={{
                borderLeft: "3px solid rgba(79,158,255,0.40)",
                background: "linear-gradient(135deg,rgba(79,158,255,0.05) 0%,rgba(6,182,212,0.02) 100%)",
              }}
            >
              <div className="px-4 py-3 space-y-1.5">
                <span className="block text-[9px] font-extrabold uppercase tracking-[0.12em]" style={{ color: "rgba(79,158,255,0.65)" }}>
                  About this gamer
                </span>
        ...
        {REVIEW_CHIPS.map((chip) => {
          ...
          return (
            <button
              ...
              style={active
                ? { background: "rgba(79,158,255,0.2)", borderColor: "rgba(79,158,255,0.6)", color: "#4F9EFF" }
...
function ReviewPanel({ requestId, currentUserId, awaitingReviews }: { requestId: number; currentUserId: number; awaitingReviews?: boolean }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden border-2 border-yellow-500/40"
      style={{ background: "linear-gradient(135deg, rgba(234,179,8,0.05), rgba(79,158,255,0.04))", boxShadow: "0 0 28px rgba(234,179,8,0.10)" }}>
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          {isGamer && !isBulkRequest && request.status === "in_progress" && !sessionStarted && (
            <div className="rounded-xl border border-primary/40 bg-primary/5 p-4 space-y-3">
              ...
              <Button
                className="bg-primary font-bold uppercase text-sm shadow-[0_0_16px_rgba(79,158,255,0.3)] hover:shadow-[0_0_24px_rgba(79,158,255,0.5)] transition-all"
          ...
          <div className="space-y-3">
            ...
            {!loadingBids && bids.length > 1 && (
              ...
              <div
                ...
                style={{
                  borderColor: activeTags.length > 0 ? "rgba(79,158,255,0.40)" : "rgba(255,255,255,0.09)",
                  background: "rgba(7,5,16,0.94)",
                  backdropFilter: "blur(20px)",
                  WebkitBackdropFilter: "blur(20px)",
                  boxShadow: activeTags.length > 0
                    ? "0 6px 32px rgba(0,0,0,0.50), 0 0 0 1px rgba(79,158,255,0.10)"
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    background: activeTags.length > 0 ? "rgba(79,158,255,0.06)" : "rgba(255,255,255,0.02)",
                    transition: "background 0.25s",
                  }}
                >
                  <div className="flex items-center gap-2">
                    <SlidersHorizontal className="h-3.5 w-3.5" style={{ color: activeTags.length > 0 ? "#4F9EFF" : "rgba(255,255,255,0.35)" }} />
                      ...
                      return (
                        <button
                          ...
                          style={active ? {
                            ...
                            color: "#4F9EFF",
                            boxShadow: "0 0 12px rgba(79,158,255,0.22)",
                          } : {
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    ...
                    <button
                      ...
                      style={bidHasStreaming ? {
                        ...
                        border: "1px solid rgba(79,158,255,0.55)",
                        color: "#4F9EFF",
                        boxShadow: "0 0 12px rgba(79,158,255,0.20)",
                      } : {
                        background: "rgba(255,255,255,0.04)",
                        border: "1px solid rgba(255,255,255,0.08)",
                        color: "rgba(255,255,255,0.45)",
                    ...
                    >
                      {bidHasStreaming
                        ? <CheckCircle2 className="h-3 w-3 shrink-0" style={{ color: "#4F9EFF" }} />
                ...
                {activeTags.length > 0 && (
                  ...
                  >
                    <span className="text-[9px] font-extrabold uppercase tracking-widest shrink-0" style={{ color: "rgba(79,158,255,0.60)" }}>
                      Active:
                    </span>
                    ...
                    <span
                      ...
                      style={{
                        color: filteredBids.length < bids.length ? "rgba(79,158,255,0.70)" : "rgba(255,255,255,0.28)",
            ...
            {!loadingBids && bids.length > 0 && filteredBids.length === 0 && (
              ...
              >
                <SlidersHorizontal className="h-7 w-7 mx-auto mb-2" style={{ color: "rgba(79,158,255,0.40)" }} />

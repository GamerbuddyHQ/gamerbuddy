...
export default function SocialsPage() {
  ...
  return (
    <div
      ...
      style={{
        background: isDark
          ? "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(172,181,255,0.07) 0%, transparent 70%)"
          : "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(172,181,255,0.05) 0%, transparent 70%)",
      }}
    >
      <div className="w-full max-w-xl mx-auto text-center space-y-10">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tight leading-tight">
            Stay{" "}
            <span style={{ color: isDark ? "#ACB5FF" : "hsl(228,60%,45%)" }}>
              Connected
            </span>{" "}
            with Player4Hire
          </h1>
        ...
        <div className="space-y-3">
          <a
            ...
            style={{
              background: "linear-gradient(135deg, #ACB5FF 0%, #8090cc 50%, #8EC1DE 100%)",
              boxShadow: "0 0 50px rgba(172,181,255,0.50), 0 6px 30px rgba(142,193,222,0.25), inset 0 1px 0 rgba(255,255,255,0.20)",
            }}
          >

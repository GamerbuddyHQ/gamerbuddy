...
export default function SocialsPage() {
  ...
  return (
    <div
      ...
      style={{
        background: isDark
          ? "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(79,158,255,0.07) 0%, transparent 70%)"
          : "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(79,158,255,0.05) 0%, transparent 70%)",
      }}
    >
      <div className="w-full max-w-xl mx-auto text-center space-y-10">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tight leading-tight">
            Stay{" "}
            <span style={{ color: isDark ? "#4F9EFF" : "hsl(228,60%,45%)" }}>
              Connected
            </span>{" "}
            with Player4Hire
          </h1>
        ...
        <div className="space-y-3">
          <a
            ...
            style={{
              background: "linear-gradient(135deg, #4F9EFF 0%, #2060c8 50%, #38BAFF 100%)",
              boxShadow: "0 0 50px rgba(79,158,255,0.50), 0 6px 30px rgba(56,186,255,0.25), inset 0 1px 0 rgba(255,255,255,0.20)",
            }}
          >

  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-16">
      ...
      <div className="space-y-6 pt-4">
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: "linear-gradient(135deg, rgba(0,212,255,0.2) 0%, rgba(88,28,135,0.1) 100%)" }}
          >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(0,212,255,0.07) 0%, rgba(34,211,238,0.07) 100%)",
        ...
        >
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            >
              <Heart className="h-5 w-5" style={{ color: "#00D4FF" }} />
            </div>
            <div>
              <p className="text-xs font-black uppercase tracking-widest mb-0.5" style={{ color: "#00D4FF" }}>
                Founder's Note
              </p>
          ...
          <Link
            ...
            style={{
              ...
              boxShadow: "0 4px 20px rgba(0,212,255,0.35), 0 0 0 1px rgba(0,212,255,0.20)",
            }}
          >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(0,212,255,0.07) 0%, rgba(34,211,238,0.04) 100%)",
      ...
      >
        <div
          ...
          style={{ background: "rgba(0,212,255,0.12)", borderColor: "rgba(0,212,255,0.30)" }}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="#00D4FF" strokeWidth={2.2} className="h-7 w-7">

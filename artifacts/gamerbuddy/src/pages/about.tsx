  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-16">
      ...
      <div className="space-y-6 pt-4">
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: "linear-gradient(135deg, rgba(0,229,205,0.2) 0%, rgba(88,28,135,0.1) 100%)" }}
          >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(0,229,205,0.07) 0%, rgba(0,229,205,0.07) 100%)",
        ...
        >
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            >
              <Heart className="h-5 w-5" style={{ color: "#00E5CD" }} />
            </div>
            <div>
              <p className="text-xs font-black uppercase tracking-widest mb-0.5" style={{ color: "#00E5CD" }}>
                Founder's Note
              </p>
          ...
          <Link
            ...
            style={{
              ...
              boxShadow: "0 4px 20px rgba(0,229,205,0.35), 0 0 0 1px rgba(0,229,205,0.20)",
            }}
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col items-center gap-1.5 shrink-0 pt-0.5">
                  <div
                    ...
                    style={{ background: "rgba(0,229,205,0.1)" }}
                  >
                    {section.number}
                  </div>
      ...
      <div
        ...
        style={{ background: "rgba(0,229,205,0.03)", borderColor: "rgba(0,229,205,0.15)" }}
      >
        <div className="flex items-start gap-4">
          {/* Icon */}
          <div className="flex flex-col items-center gap-1.5 shrink-0 pt-0.5">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(0,229,205,0.07) 0%, rgba(0,229,205,0.04) 100%)",
          borderColor: "rgba(0,229,205,0.22)",
          boxShadow: "0 0 30px rgba(0,229,205,0.08)",
        }}
      >
        <div
          className="shrink-0 h-14 w-14 rounded-2xl border flex items-center justify-center"
          style={{ background: "rgba(0,229,205,0.12)", borderColor: "rgba(0,229,205,0.30)" }}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="#00E5CD" strokeWidth={2.2} className="h-7 w-7">
            <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
          </svg>
        </div>
        <div className="flex-1 text-center sm:text-left space-y-1.5">
          <p className="text-[11px] font-black uppercase tracking-widest" style={{ color: "#00E5CD" }}>
        ...
        <a
          ...
          style={{
            background: "linear-gradient(135deg, #00E5CD 0%, #00b0a0 60%, #00E5CD 100%)",
            boxShadow: "0 4px 24px rgba(0,229,205,0.30)",
          }}
        >

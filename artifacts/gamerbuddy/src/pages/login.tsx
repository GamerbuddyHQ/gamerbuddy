      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center">
        ...
        <div>
          <Card className="border-primary/20 bg-card/50 backdrop-blur-sm overflow-hidden">
            <div className="h-1 w-full" style={{ background: "linear-gradient(90deg, #88cc33, #A1FF4F, #A1FF4F)" }} />
            ...
            <CardHeader className="space-y-2 text-center pt-8 pb-4">
              <div className="flex justify-center mb-2">
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg, rgba(161,255,79,0.2), rgba(161,255,79,0.1))",
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <Button
                    ...
                    style={isLocked ? {
                      ...
                      background: "linear-gradient(135deg, #88cc33 0%, #88cc33 100%)",
                      boxShadow: "0 4px 20px rgba(161,255,79,0.35)",
                    }}
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    className="relative flex flex-col items-start gap-2 rounded-xl px-4 py-3.5 text-left transition-all duration-200 hover:scale-[1.02] active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
                    style={{
                      background: "linear-gradient(135deg, rgba(161,255,79,0.20) 0%, rgba(236,72,153,0.12) 100%)",
                      border: "1.5px solid rgba(161,255,79,0.40)",
                      boxShadow: "0 2px 12px rgba(161,255,79,0.15)",
                    }}
                  >
                    <div className="flex items-center gap-2 w-full">
                      <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0" style={{ background: "rgba(161,255,79,0.25)" }}>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div
                ...
                style={{ background: "linear-gradient(135deg, rgba(161,255,79,0.25), rgba(161,255,79,0.15))", border: "1px solid rgba(161,255,79,0.35)" }}
              >
          ...
          <div className="space-y-3">
            {featureItems.map(({ icon: Icon, label, desc }) => (
              <div
                ...
                style={{ background: "rgba(161,255,79,0.06)", border: "1px solid rgba(161,255,79,0.12)" }}
              >
                <div
                  className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 mt-0.5"
                  style={{ background: "rgba(161,255,79,0.15)", border: "1px solid rgba(161,255,79,0.25)" }}
                >

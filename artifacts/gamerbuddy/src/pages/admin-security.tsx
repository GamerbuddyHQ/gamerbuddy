...
function WalletPill({ wallet }: { wallet: string }) {
  const color = wallet === "hiring" ? "#00E5CD" : "#00E5CD";
  return (
    <span
      ...
      {isLoading ? (
        ...
        <>
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <StatCard icon={Users}      label="Total Users"         value={data.users.total}    sub="All registered accounts"   color="#00E5CD" />
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <StatCard icon={TrendingUp}    label="Large Txns"      value={largeTxCount} sub="Transactions ≥ $500"     color="#00E5CD" />
            </div>
          </div>
        </>
      ) : null}
      ...
      >
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: "rgba(0,229,205,0.12)", border: "1px solid rgba(0,229,205,0.25)" }}
          >
            <DollarSign className="h-5 w-5" style={{ color: "#00E5CD" }} />
          </div>
          <div>
        ...
        <a
          ...
          style={{ borderColor: "rgba(0,229,205,0.40)", color: "#00E5CD", background: "rgba(0,229,205,0.08)" }}
        >
          View Earnings →
        </a>
      </div>

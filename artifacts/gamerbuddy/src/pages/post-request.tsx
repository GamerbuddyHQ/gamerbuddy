          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7">
                          ...
                          return (
                            <button
                              ...
                              className={`relative flex flex-col items-center gap-1.5 rounded-lg border py-3 px-2 text-xs font-semibold transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed
                                ${isSelected
                                  ? "border-primary/60 bg-primary/10 text-primary shadow-[0_0_12px_rgba(220,206,64,0.25)] scale-[1.03]"
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-start gap-2.5 rounded-lg border p-3 text-left transition-all duration-150 disabled:opacity-40 disabled:cursor-not-allowed
                              ${isSelected
                                ? `${color} shadow-[0_0_10px_rgba(220,206,64,0.15)] scale-[1.02]`
              ...
              <div
                ...
                style={{ borderColor: "rgba(220,206,64,0.30)", background: "rgba(220,206,64,0.04)" }}
              >
                <div className="flex items-center gap-2">
                  {hirerRegion === "india" ? (
              ...
              <div className="border-t border-border pt-5 space-y-3">
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 text-white font-extrabold uppercase tracking-widest text-base py-6 shadow-[0_0_20px_rgba(220,206,64,0.3)] hover:shadow-[0_0_30px_rgba(220,206,64,0.5)] transition-all disabled:opacity-50 disabled:shadow-none"

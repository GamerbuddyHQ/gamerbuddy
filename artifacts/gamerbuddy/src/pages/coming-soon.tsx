      ...
      <div className="max-w-md w-full text-center space-y-10">
        ...
        <div className="relative flex items-center justify-center mx-auto h-24 w-24">
          <div
            ...
            style={{
              background: "radial-gradient(circle at center, rgba(0,212,255,0.18) 0%, transparent 72%)",
              filter: "blur(12px)",
              transform: "scale(1.6)",
            }}
          />
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(0,212,255,0.14) 0%, rgba(0,212,255,0.08) 100%)",
              border: "1px solid rgba(0,212,255,0.22)",
              backdropFilter: "blur(12px)",
            }}
          >
            <Sparkles className="h-8 w-8" style={{ color: "rgba(0,212,255,0.75)" }} />
          </div>
        </div>
        ...
        <div className="flex items-stretch rounded-2xl overflow-hidden border border-border/50">
          ...
          >
            <span
              className="h-2 w-2 rounded-full shrink-0"
              style={{ background: "rgba(0,212,255,0.6)", boxShadow: "0 0 5px rgba(0,212,255,0.4)" }}
            />
            <div className="text-left">
              <div className="text-[10px] font-black uppercase tracking-widest" style={{ color: "rgba(0,212,255,0.70)" }}>Phase {phase}</div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link href="/browse">
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #0099bb, #0099bb)",
                color: "#fff",

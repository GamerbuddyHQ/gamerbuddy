                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-muted-foreground leading-relaxed">
                        After signing up: (1) link a gaming account on your profile, (2) wait 24–48 hrs for verification, then (3) pay a small one-time activation fee (🌍 $5 / 🇮🇳 ₹149) to unlock posting and bidding — applies to both Hirers and Gamers. Paid once, never again. ❤️
                      </p>
                    </div>
                  </div>

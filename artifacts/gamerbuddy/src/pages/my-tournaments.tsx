...
const TYPE_COLOR: Record<TournamentType, string> = {
  h2h: "#f87171", squad: "#A1FF4F", ffa: "#fbbf24",
};
  ...
  return (
    <div className="py-14 flex flex-col items-center gap-4 text-center">
      <div className="h-16 w-16 rounded-2xl flex items-center justify-center"
        style={{ background: "rgba(161,255,79,0.08)", border: "1.5px solid rgba(161,255,79,0.18)" }}>
      ...
      <Button asChild size="sm" className="font-bold text-xs px-5 h-8"
        style={tab === "hosted"
          ...
          : { background: "linear-gradient(135deg,#A1FF4F,#88cc33)", color: "#fff" }}>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10"
        style={{ background: "radial-gradient(ellipse 55% 25% at 50% 0%,rgba(161,255,79,0.07) 0%,transparent 55%)" }} />
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Button asChild size="sm" className="font-bold text-xs h-8 px-4"
          style={{ background: "linear-gradient(135deg,rgba(161,255,79,0.20),rgba(161,255,79,0.10))", border: "1px solid rgba(161,255,79,0.35)", color: "#A1FF4F" }}>
        ...
        {(["hosted", "joined"] as const).map((t) => {
          ...
          return (
            <button
              ...
              style={active ? {
                background: "linear-gradient(135deg,rgba(161,255,79,0.22),rgba(161,255,79,0.10))",
                border: "1px solid rgba(161,255,79,0.40)",
                color: "#A1FF4F",
                boxShadow: "0 0 20px rgba(161,255,79,0.12)",
              } : {
            ...
            >
              ...
              {!isLoading && (
                <span className="text-[10px] font-black px-1.5 py-0.5 rounded-full ml-0.5"
                  style={active ? {
                    background: "rgba(161,255,79,0.30)",
                    border: "1px solid rgba(161,255,79,0.40)",
                    color: "#d8b4fe",
                  } : {
      ...
      {!isLoading && !isError && data && (
        <div className="flex items-center justify-center gap-6 py-1">
          {[
            { label: "Hosted", value: hostedCount, color: "#A1FF4F" },
            { label: "Joined", value: joinedCount, color: "#A1FF4F" },
            {
              label: "Wins",

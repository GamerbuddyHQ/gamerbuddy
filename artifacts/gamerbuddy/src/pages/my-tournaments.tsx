...
const TYPE_COLOR: Record<TournamentType, string> = {
  h2h: "#f87171", squad: "#a855f7", ffa: "#fbbf24",
};
  ...
  return (
    <div className="py-14 flex flex-col items-center gap-4 text-center">
      <div className="h-16 w-16 rounded-2xl flex items-center justify-center"
        style={{ background: "rgba(168,85,247,0.08)", border: "1.5px solid rgba(168,85,247,0.18)" }}>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Button asChild size="sm" className="font-bold text-xs h-8 px-4"
          style={{ background: "linear-gradient(135deg,rgba(168,85,247,0.20),rgba(168,85,247,0.10))", border: "1px solid rgba(168,85,247,0.35)", color: "#c084fc" }}>
      ...
      {!isLoading && !isError && data && (
        <div className="flex items-center justify-center gap-6 py-1">
          {[
            { label: "Hosted", value: hostedCount, color: "#a855f7" },

  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 h-4 min-w-[1rem] px-0.5 rounded-full bg-primary text-white text-[9px] font-black flex items-center justify-center leading-none shadow-[0_0_8px_rgba(200,240,0,0.6)]">
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </button>
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 60px rgba(200,240,0,0.20), 0 20px 60px rgba(0,0,0,0.8)",
        }}
      >
        <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(200,240,0,0.45), transparent)" }} />
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0"
              style={{ background: "rgba(200,240,0,0.15)", border: "1px solid rgba(200,240,0,0.30)" }}
            >
          ...
          <div className="flex gap-2 flex-wrap mb-4">
            {[
              ...
              <span
                ...
                style={{ background: "rgba(200,240,0,0.10)", border: "1px solid rgba(200,240,0,0.25)", color: "rgba(200,240,0,0.80)" }}
              >
                {l.flag} {l.label}
              </span>
            ))}
          ...
          <button
            onClick={onClose}
            className="w-full py-2.5 rounded-xl font-black uppercase tracking-widest text-sm text-[#C8F000] transition-all hover:brightness-110"
            style={{ background: "#111111", border: "1.5px solid #C8F000", boxShadow: "0 3px 10px rgba(0,0,0,0.40)" }}
          >
            Got it!
          </button>
        </div>
              ...
              {displayLangs.map((l) => {
                ...
                return (
                  <button
                    ...
                    style={isActive ? { color: "#C8F000" } : { color: "rgba(255,255,255,0.70)" }}
                  >
                    ...
                    {isComingSoon ? (
                      <span
                        ...
                        style={{ background: "rgba(200,240,0,0.15)", color: "rgba(200,240,0,0.80)", border: "1px solid rgba(200,240,0,0.25)" }}
                      >
                        Soon
                      </span>
                    ) : isActive ? (
          ...
          return (
            <button
              ...
              style={isActive ? {
                ...
                borderColor: "rgba(200,240,0,0.40)",
                color: "#C8F000",
              } : {
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {isComingSoon && (
                  <span className="text-[9px] font-black uppercase tracking-wide" style={{ color: "rgba(200,240,0,0.70)" }}>Soon</span>
                )}
              </div>
            </button>
          );
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Link href="/" className="flex items-center group navbar-logo">
              ...
              >
                ...
                <span style={{ color: "#C8F000" }}>4</span>
                ...
                return (
                  <El
                    ...
                    style={isActive ? {
                      ...
                      border: "1px solid rgba(200,240,0,0.55)",
                      color: "#C8F000",
                    } : {
                      background: "transparent",
                      border: "1px solid rgba(200,240,0,0.25)",
                      color: "rgba(200,240,0,0.60)",
                    }}
                  >
                    {item.label}
                  </El>
                ...
                return (
                  <Link
                    ...
                    style={isActive ? {
                      ...
                      border: "1px solid rgba(200,240,0,0.55)",
                      color: "#C8F000",
                      boxShadow: "0 0 12px rgba(200,240,0,0.20)",
                    } : {
          ...
          <div className="flex items-center gap-1.5 shrink-0 ml-auto lg:ml-0">
            ...
            {user ? (
              ...
              <div className="relative hidden md:block" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div
                    ...
                    style={{ width: 200, boxShadow: "0 16px 48px rgba(0,0,0,0.32), 0 0 0 1px rgba(200,240,0,0.10)" }}
                  >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Link
                  href="/signup"
                  className="h-9 px-4 flex items-center text-[13px] font-bold text-[#C8F000] rounded-xl transition-all hover:brightness-110 active:scale-95"
                  style={{
                    background: "#111111",
              ...
              if (isExternal || isCyan) {
                return (
                  <a
                    ...
                    style={{ background: "rgba(200,240,0,0.07)", borderColor: "rgba(200,240,0,0.28)", color: "rgba(200,240,0,0.80)" }}
                  >
              ...
              if (isGradient) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(200,240,0,0.08)",
                      borderColor: "rgba(200,240,0,0.55)", color: "#C8F000",
                    } : {
                      background: "transparent",
                      borderColor: "rgba(200,240,0,0.25)", color: "rgba(200,240,0,0.60)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
              ...
              if (isPurple) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(200,240,0,0.14)", borderColor: "rgba(200,240,0,0.55)", color: "#C8F000",
                      boxShadow: "0 0 16px rgba(200,240,0,0.16)",
                    } : {
                      background: "rgba(200,240,0,0.05)", borderColor: "rgba(200,240,0,0.28)", color: "rgba(200,240,0,0.75)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
            ...
            <div className="pt-4 border-t border-border/40 space-y-2">
              {user ? (
                ...
                <>
                  <Link
                    href="/signup"
                    className="flex items-center justify-center w-full py-3.5 rounded-xl font-black text-[15px] text-[#C8F000] transition-all hover:brightness-110"
                    style={{ background: "#111111", border: "1.5px solid #C8F000", boxShadow: "0 3px 10px rgba(0,0,0,0.40)" }}
                  >
                    {t.nav.signUp}
                  </Link>

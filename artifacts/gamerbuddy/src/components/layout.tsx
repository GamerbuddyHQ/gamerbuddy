  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 h-4 min-w-[1rem] px-0.5 rounded-full bg-primary text-[#0A0A0E] text-[9px] font-black flex items-center justify-center leading-none shadow-[0_0_8px_rgba(232,255,0,0.6)]">
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </button>
...
function LangComingSoonModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(232,255,0,0.45), transparent)" }} />
        <div className="p-6">
              ...
              if (isGradient) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(232,255,0,0.08)",
                      borderColor: "rgba(232,255,0,0.55)", color: "#E8FF00",
                    } : {
                      background: "transparent",
                      borderColor: "rgba(232,255,0,0.25)", color: "rgba(232,255,0,0.60)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
              ...
              {user ? (
                ...
                <>
                  <Link
                    ...
                    style={{ background: "linear-gradient(135deg, #E8FF00 0%, #C8D100 100%)", boxShadow: "0 3px 14px rgba(255,59,92,0.40)" }}
                  >
                    {t.nav.signUp}
                  </Link>
                  <Link

  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 h-4 min-w-[1rem] px-0.5 rounded-full text-[#D4FF00] text-[9px] font-black flex items-center justify-center leading-none" style={{ background: "#1A1A1A", border: "1px solid rgba(212,255,0,0.50)" }}>
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </button>
...
function LangComingSoonModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(212,255,0,0.45), transparent)" }} />
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0"
              style={{ background: "rgba(212,255,0,0.15)", border: "1px solid rgba(212,255,0,0.30)" }}
            >
          ...
          <div className="flex gap-2 flex-wrap mb-4">
            {[
              ...
              <span
                ...
                style={{ background: "rgba(212,255,0,0.10)", border: "1px solid rgba(212,255,0,0.25)", color: "rgba(212,255,0,0.80)" }}
              >
                {l.flag} {l.label}
              </span>
            ))}
          ...
          <button
            onClick={onClose}
            className="w-full py-2.5 rounded-xl font-black uppercase tracking-widest text-sm text-[#D4FF00] transition-all hover:brightness-110"
            style={{ background: "#1A1A1A", border: "1.5px solid rgba(212,255,0,0.55)", boxShadow: "0 3px 14px rgba(0,0,0,0.50)" }}
          >
            Got it!
          </button>
        </div>
              ...
              {displayLangs.map((l) => {
                ...
                return (
                  <button
                    ...
                    style={isActive ? { color: "#D4FF00" } : { color: "rgba(255,255,255,0.70)" }}
                  >
                    ...
                    {isComingSoon ? (
                      <span
                        ...
                        style={{ background: "rgba(212,255,0,0.15)", color: "rgba(212,255,0,0.80)", border: "1px solid rgba(212,255,0,0.25)" }}
                      >
                        Soon
                      </span>
                    ) : isActive ? (
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {isComingSoon && (
                  <span className="text-[9px] font-black uppercase tracking-wide" style={{ color: "rgba(212,255,0,0.70)" }}>Soon</span>
                )}
              </div>
            </button>
          );
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Link href="/" className="flex items-center group navbar-logo">
              ...
              >
                ...
                <span style={{ color: "#D4FF00" }}>4</span>
                ...
                return (
                  <Link
                    ...
                    style={isActive ? {
                      ...
                      border: "1px solid rgba(212,255,0,0.55)",
                      color: "#D4FF00",
                      boxShadow: "0 0 12px rgba(212,255,0,0.20)",
                    } : {
          ...
          <div className="flex items-center gap-1.5 shrink-0 ml-auto lg:ml-0">
            ...
            {user ? (
              ...
              <div className="relative hidden md:block" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div
                    ...
                    style={{ width: 200, boxShadow: "0 16px 48px rgba(0,0,0,0.32), 0 0 0 1px rgba(212,255,0,0.10)" }}
                  >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Link
                  href="/signup"
                  className="h-9 px-4 flex items-center text-[13px] font-bold text-[#D4FF00] rounded-xl transition-all hover:brightness-110 active:scale-95"
                  style={{
                    background: "#1A1A1A",
              ...
              if (isExternal || isCyan) {
                return (
                  <a
                    ...
                    style={{ background: "rgba(212,255,0,0.07)", borderColor: "rgba(212,255,0,0.28)", color: "rgba(212,255,0,0.80)" }}
                  >
              ...
              if (isGradient) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(212,255,0,0.08)",
                      borderColor: "rgba(212,255,0,0.55)", color: "#D4FF00",
                    } : {
                      background: "transparent",
                      borderColor: "rgba(212,255,0,0.25)", color: "rgba(212,255,0,0.60)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
              ...
              if (isPurple) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(212,255,0,0.14)", borderColor: "rgba(212,255,0,0.55)", color: "#D4FF00",
                      boxShadow: "0 0 16px rgba(212,255,0,0.16)",
                    } : {
                      background: "rgba(212,255,0,0.05)", borderColor: "rgba(212,255,0,0.28)", color: "rgba(212,255,0,0.75)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
            ...
            <div className="pt-4 border-t border-border/40 space-y-2">
              {user ? (
                ...
                <>
                  <Link
                    href="/signup"
                    className="flex items-center justify-center w-full py-3.5 rounded-xl font-black text-[15px] text-[#D4FF00] transition-all hover:brightness-110"
                    style={{ background: "#1A1A1A", border: "1.5px solid rgba(212,255,0,0.55)", boxShadow: "0 3px 14px rgba(0,0,0,0.50)" }}
                  >
                    {t.nav.signUp}
                  </Link>

  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 h-4 min-w-[1rem] px-0.5 rounded-full bg-primary text-white text-[9px] font-black flex items-center justify-center leading-none shadow-[0_0_8px_rgba(0,229,205,0.6)]">
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </button>
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 60px rgba(0,229,205,0.20), 0 20px 60px rgba(0,0,0,0.8)",
        }}
      >
        <div className="h-1 w-full" style={{ background: "linear-gradient(90deg, #00E5CD, #00E5CD, #00b0a0)" }} />
        <div className="p-6">
          ...
          <div className="flex gap-2 flex-wrap mb-4">
            {[
              ...
              <span
                ...
                style={{ background: "rgba(0,229,205,0.10)", border: "1px solid rgba(0,229,205,0.25)", color: "rgba(0,229,205,0.80)" }}
              >
                {l.flag} {l.label}
              </span>
            ))}
          ...
          <button
            ...
            style={{ background: "linear-gradient(135deg, #00b0a0 0%, #00E5CD 100%)", boxShadow: "0 4px 16px rgba(0,229,205,0.30)" }}
          >
            Got it!
          </button>
        </div>
              ...
              {displayLangs.map((l) => {
                ...
                return (
                  <button
                    ...
                    style={isActive ? { color: "#00E5CD" } : { color: "rgba(255,255,255,0.70)" }}
                  >
                    ...
                    {isComingSoon ? (
                      <span
                        ...
                        style={{ background: "rgba(0,229,205,0.15)", color: "rgba(0,229,205,0.80)", border: "1px solid rgba(0,229,205,0.25)" }}
                      >
                        Soon
                      </span>
                    ) : isActive ? (
          ...
          return (
            <button
              ...
              style={isActive ? {
                ...
                borderColor: "rgba(0,229,205,0.40)",
                color: "#00E5CD",
              } : {
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {isComingSoon && (
                  <span className="text-[9px] font-black uppercase tracking-wide" style={{ color: "rgba(0,229,205,0.70)" }}>Soon</span>
                )}
              </div>
            </button>
          );
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Link href="/" className="flex items-center group navbar-logo">
              ...
              >
                ...
                <span style={{ color: "#00E5CD" }}>4</span>
                <span style={{ color: "#E0E0FF" }}>Hire</span>
              </span>
            </Link>
          </div>
              ...
              if (item.style === "gradient") {
                ...
                return (
                  <El
                    ...
                    style={isActive ? {
                      background: "linear-gradient(135deg, #00E5CD 0%, #00b0a0 60%, #00E5CD 100%)",
                      border: "1px solid rgba(0,229,205,0.70)",
                      color: "#fff",
                      boxShadow: "0 0 16px rgba(0,229,205,0.35), 0 0 4px rgba(0,229,205,0.15)",
                    } : {
                      background: "linear-gradient(135deg, rgba(0,229,205,0.10) 0%, rgba(0,229,205,0.10) 100%)",
              ...
              if (item.style === "cyan") {
                ...
                return (
                  <El
                    ...
                    style={{
                      background: "rgba(0,229,205,0.07)",
                      border: "1px solid rgba(0,229,205,0.28)",
                      color: "rgba(0,229,205,0.75)",
                    }}
                  >
                    {item.label}
                  </El>
              ...
              <div className="relative hidden md:block" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div
                    ...
                    style={{ width: 200, boxShadow: "0 16px 48px rgba(0,0,0,0.32), 0 0 0 1px rgba(0,229,205,0.10)" }}
                  >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Link
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 14px rgba(0,229,205,0.35)",
                  }}
                >
                  {t.nav.signUp}
                </Link>
              ...
              if (isExternal || isCyan) {
                return (
                  <a
                    ...
                    style={{ background: "rgba(0,229,205,0.07)", borderColor: "rgba(0,229,205,0.28)", color: "rgba(0,229,205,0.80)" }}
                  >
              ...
              if (isGradient) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "linear-gradient(135deg, #00E5CD 0%, #00b0a0 60%, #00E5CD 100%)",
                      borderColor: "rgba(0,229,205,0.70)", color: "#fff",
                      boxShadow: "0 0 20px rgba(0,229,205,0.30)",
                    } : {
                      background: "linear-gradient(135deg, rgba(0,229,205,0.10) 0%, rgba(0,229,205,0.10) 100%)",
                      borderColor: "rgba(0,229,205,0.35)", color: "rgba(0,229,205,0.90)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
              ...
              if (isPurple) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(0,229,205,0.14)", borderColor: "rgba(0,229,205,0.55)", color: "#00E5CD",
                      boxShadow: "0 0 16px rgba(0,229,205,0.16)",
                    } : {
                      background: "rgba(0,229,205,0.05)", borderColor: "rgba(0,229,205,0.28)", color: "rgba(0,229,205,0.75)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}

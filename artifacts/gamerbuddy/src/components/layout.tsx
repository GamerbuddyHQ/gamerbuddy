  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 h-4 min-w-[1rem] px-0.5 rounded-full bg-primary text-white text-[9px] font-black flex items-center justify-center leading-none shadow-[0_0_8px_rgba(79,158,255,0.6)]">
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </button>
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 60px rgba(79,158,255,0.20), 0 20px 60px rgba(0,0,0,0.8)",
        }}
      >
        <div className="h-1 w-full" style={{ background: "linear-gradient(90deg, #38BAFF, #4F9EFF, #2060c8)" }} />
        <div className="p-6">
          ...
          <div className="flex gap-2 flex-wrap mb-4">
            {[
              ...
              <span
                ...
                style={{ background: "rgba(79,158,255,0.10)", border: "1px solid rgba(79,158,255,0.25)", color: "rgba(79,158,255,0.80)" }}
              >
                {l.flag} {l.label}
              </span>
            ))}
          ...
          <button
            ...
            style={{ background: "linear-gradient(135deg, #2060c8 0%, #4F9EFF 100%)", boxShadow: "0 4px 16px rgba(79,158,255,0.30)" }}
          >
            Got it!
          </button>
        </div>
              ...
              {displayLangs.map((l) => {
                ...
                return (
                  <button
                    ...
                    style={isActive ? { color: "#4F9EFF" } : { color: "rgba(255,255,255,0.70)" }}
                  >
                    ...
                    {isComingSoon ? (
                      <span
                        ...
                        style={{ background: "rgba(79,158,255,0.15)", color: "rgba(79,158,255,0.80)", border: "1px solid rgba(79,158,255,0.25)" }}
                      >
                        Soon
                      </span>
                    ) : isActive ? (
          ...
          return (
            <button
              ...
              style={isActive ? {
                ...
                borderColor: "rgba(79,158,255,0.40)",
                color: "#4F9EFF",
              } : {
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {isComingSoon && (
                  <span className="text-[9px] font-black uppercase tracking-wide" style={{ color: "rgba(79,158,255,0.70)" }}>Soon</span>
                )}
              </div>
            </button>
          );
                ...
                return (
                  <El
                    ...
                    style={isActive ? {
                      ...
                      border: "1px solid rgba(79,158,255,0.70)",
                      color: "#fff",
                      boxShadow: "0 0 16px rgba(79,158,255,0.35), 0 0 4px rgba(56,186,255,0.15)",
                    } : {
                      background: "linear-gradient(135deg, rgba(79,158,255,0.10) 0%, rgba(56,186,255,0.10) 100%)",
              ...
              if (item.style === "cyan") {
                ...
                return (
                  <El
                    ...
                    style={{
                      background: "rgba(56,186,255,0.07)",
                      border: "1px solid rgba(56,186,255,0.28)",
                      color: "rgba(56,186,255,0.75)",
                    }}
                  >
                    {item.label}
                  </El>
              ...
              <div className="relative hidden md:block" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div
                    ...
                    style={{ width: 200, boxShadow: "0 16px 48px rgba(0,0,0,0.32), 0 0 0 1px rgba(79,158,255,0.10)" }}
                  >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Link
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 14px rgba(79,158,255,0.35)",
                  }}
                >
                  {t.nav.signUp}
                </Link>
              ...
              if (isExternal || isCyan) {
                return (
                  <a
                    ...
                    style={{ background: "rgba(56,186,255,0.07)", borderColor: "rgba(56,186,255,0.28)", color: "rgba(56,186,255,0.80)" }}
                  >
              ...
              if (isGradient) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "linear-gradient(135deg, #4F9EFF 0%, #2060c8 60%, #38BAFF 100%)",
                      borderColor: "rgba(79,158,255,0.70)", color: "#fff",
                      boxShadow: "0 0 20px rgba(79,158,255,0.30)",
                    } : {
                      background: "linear-gradient(135deg, rgba(79,158,255,0.10) 0%, rgba(56,186,255,0.10) 100%)",
                      borderColor: "rgba(79,158,255,0.35)", color: "rgba(79,158,255,0.90)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}
              ...
              if (isPurple) {
                return (
                  <Link
                    ...
                    style={isActive ? {
                      background: "rgba(79,158,255,0.14)", borderColor: "rgba(79,158,255,0.55)", color: "#4F9EFF",
                      boxShadow: "0 0 16px rgba(79,158,255,0.16)",
                    } : {
                      background: "rgba(79,158,255,0.05)", borderColor: "rgba(79,158,255,0.28)", color: "rgba(79,158,255,0.75)",
                    }}
                  >
                    <item.icon className="h-5 w-5 shrink-0" />
                    {item.label}

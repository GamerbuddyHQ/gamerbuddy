  ...
  return (
    <div
      ...
      style={{
        ...
        background: "linear-gradient(135deg, rgba(245,158,11,0.06), rgba(79,158,255,0.05))",
    ...
    >
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div
          ...
          style={{ background: "rgba(79,158,255,0.06)", border: "1px solid rgba(79,158,255,0.16)" }}
        >

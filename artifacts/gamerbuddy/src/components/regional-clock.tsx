    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          ...
          style={{ boxShadow: "0 16px 48px rgba(0,0,0,0.32), 0 0 0 1px rgba(172,181,255,0.12)", maxHeight: "min(580px, 88dvh)" }}
        >
          {/* Header */}
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg, rgba(172,181,255,0.08) 0%, rgba(172,181,255,0.02) 100%)" }}
          >
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <span className="text-[32px] leading-none shrink-0" style={{ filter: "drop-shadow(0 0 8px rgba(172,181,255,0.4))" }}>
                  {primary.flag}
                </span>
                <div className="min-w-0">
                  <div className="font-black tabular-nums leading-none" style={{ fontSize: "38px", letterSpacing: "-0.04em", color: "hsl(var(--primary))", textShadow: "0 0 24px rgba(172,181,255,0.5)" }}>
                    {primaryTime}
                  </div>

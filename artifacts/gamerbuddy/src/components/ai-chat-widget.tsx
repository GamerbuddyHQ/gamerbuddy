...
const RESPONSES: Array<{ patterns: RegExp; reply: string }> = [
  ...
  /* ── PAYOUT TIMING / WITHDRAWAL SCHEDULE ── */
  {
    ...
    reply: `💸 **Gamerbuddy Payout Policy — Full Breakdown**\n\n**Step 1 — When are earnings credited?**\nFor ALL Gamers worldwide: your earnings land in your **Earnings Wallet immediately** after:\n✅ Session is marked complete\n✅ Both parties have submitted their reviews\n\n---\n\n**Step 2 — When can you withdraw?**\nOnce your Earnings Wallet balance reaches **$100 USD**, you're eligible to request a withdrawal.\n\n---\n\n**Step 3 — How are payouts processed?**\n📅 Payouts to bank accounts are processed in a **weekly batch every Monday** via Razorpay / Bank Transfer\n⏱️ Funds typically arrive in your account within **5–7 business days** after the Monday batch runs\n\n**Example:** If you request a withdrawal on Wednesday, your request joins the queue. It's processed the following Monday, then arrives in your bank account within 5–7 business days after that.\n\n---\n\n**Minimum threshold:** $100 USD\n**Payout method:** International Bank Transfer (Razorpay)\n**Frequency:** Once per week, every Monday\n**Settlement:** 5–7 business days after Monday processing\n\nManage everything from your **[Wallets](/wallets)** page. 💰`,
  },

  /* ── WALLETS ── */
  {
    patterns: /wallet|deposit|withdraw|add.*fund|fund|money|pay(?:ment)?|transfer|balance/i,
    reply: `Gamerbuddy runs on **two separate wallets** — here's the full breakdown 💸\n\n🔵 **Hiring Wallet** — fund this to hire gamers\n• Deposit via **Razorpay** (UPI, GPay, PhonePe, Paytm, cards…)\n• Min deposit: **$10.75** | Max wallet balance: **$1,000**\n• **Cannot be withdrawn** — only spent on game sessions and tips\n\n🟢 **Earnings Wallet** — where your gamer income lands\n• Earn **90%** of every accepted bid when the session completes (10% platform fee)\n• Earnings are credited **immediately** after session completion + both reviews submitted\n• Withdraw once your balance hits **$100 USD**\n• 📅 Payouts are processed in a **weekly batch every Monday** via Bank Transfer\n• ⏱️ Funds arrive in your account within **5–7 business days** after the Monday batch\n\n🔒 The moment a bid is accepted, funds lock into **escrow** — safe and untouchable by either side until the session is done.\n\nHead to **[Wallets](/wallets)** or **[Add Funds](/add-funds)** to get started! 💪`,
  },

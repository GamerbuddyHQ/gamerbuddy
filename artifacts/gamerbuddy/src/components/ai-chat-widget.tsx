...
function renderMarkdown(text: string) {
  ...
  return lines.map((line, i) => {
    const processed = line
      ...
      .replace(/`(.*?)`/g, "<code style='font-size:11px;background:rgba(255,77,45,0.15);padding:1px 4px;border-radius:4px'>$1</code>");
    return (
      <span key={i}>
  ...
  if (!open) {
    return (
      <button
        ...
        style={{ background: "linear-gradient(135deg, #cc3a1e 0%, #FF4D2D 50%, #cc3a1e 100%)", boxShadow: "0 0 24px rgba(255,77,45,0.45), 0 4px 20px rgba(0,0,0,0.4)" }}
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 0 40px rgba(255,77,45,0.18), 0 8px 32px rgba(0,0,0,0.6)",
      }}
    >
      {/* Header */}
      <div
        className="flex items-center justify-between px-4 py-3 shrink-0"
        style={{ background: "linear-gradient(90deg, rgba(255,77,45,0.6) 0%, rgba(255,77,45,0.4) 100%)", borderBottom: "1px solid rgba(255,77,45,0.2)" }}
      >
      ...
      {!minimized && (
        <>
          ...
          <div className="flex-1 overflow-y-auto px-3.5 py-3 space-y-3 scrollbar-thin">
            {messages.map((msg) => (
              <div key={msg.id} className={`flex gap-2 ${msg.role === "user" ? "flex-row-reverse" : "flex-row"}`}>
                <div
                  ...
                  style={
                    msg.role === "assistant"
                      ? { background: "rgba(255,77,45,0.15)", border: "1px solid rgba(255,77,45,0.3)" }
                      : { background: "rgba(255,77,45,0.15)", border: "1px solid rgba(255,77,45,0.3)" }
                  }
                >
                  {msg.role === "assistant"
                ...
                <div
                  ...
                  style={
                    msg.role === "assistant"
                      ? { background: "rgba(255,77,45,0.08)", border: "1px solid rgba(255,77,45,0.15)", color: "rgba(255,255,255,0.88)" }
                      : { background: "rgba(255,77,45,0.12)", border: "1px solid rgba(255,77,45,0.2)", color: "rgba(255,255,255,0.92)" }
                  }
                >
            ...
            {typing && (
              <div className="flex gap-2">
                <div className="shrink-0 h-7 w-7 rounded-full flex items-center justify-center" style={{ background: "rgba(255,77,45,0.15)", border: "1px solid rgba(255,77,45,0.3)" }}>
                  <Bot className="h-3.5 w-3.5 text-primary" />
                </div>
                <div className="rounded-2xl px-4 py-3" style={{ background: "rgba(255,77,45,0.08)", border: "1px solid rgba(255,77,45,0.15)" }}>
          ...
          <div className="px-3.5 pb-2 shrink-0">
            <a
              ...
              style={{
                ...
                boxShadow: "0 0 14px rgba(255,77,45,0.25)",
              }}
            >
          ...
          {/* Input */}
          <div className="px-3.5 pb-3.5 pt-2 shrink-0" style={{ borderTop: "1px solid rgba(255,77,45,0.12)" }}>
            <div
              className="flex items-center gap-2 rounded-xl px-3.5 py-2"
              style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,77,45,0.2)" }}
            >
              <input
              ...
              <button
                ...
                style={input.trim()
                  ? { background: "rgba(255,77,45,0.25)", border: "1px solid rgba(255,77,45,0.4)", color: "#FF4D2D" }

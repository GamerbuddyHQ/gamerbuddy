...
const RESPONSES: Array<{ patterns: RegExp; reply: string }> = [
  ...
  {
    patterns: /payout|pay.?out|when.*get paid|when.*paid|withdrawal.*time|time.*withdraw|how long.*withdraw|how long.*pay|when.*money|monday.*payout|weekly.*payout|payout.*week|5.7.*day|5-7.*business|international.*withdraw|india.*withdraw|upi.*withdraw|bank.*transfer.*time|instant.*pay|same.?day.*pay/i,
    reply: `💸 **Gamerbuddy Payout Policy — Full Breakdown**\n\n**Step 1 — When are earnings credited?**\nFor BOTH Indian and International Gamers: your earnings land in your **Earnings Wallet immediately** after:\n✅ Session is marked complete\n✅ Both parties have submitted their reviews\n\n---\n\n🇮🇳 **Indian Users — UPI Payouts**\n• Withdraw via **UPI** (GPay, PhonePe, Paytm, any UPI ID)\n• Processed **instantly or same-day** via Razorpay\n• Minimum threshold: **₹8,300 (~$100 USD)** in your Earnings Wallet\n• No waiting — once you request, funds usually hit your UPI within minutes\n\n---\n\n🌍 **International Users — Bank Transfer Payouts**\n• Withdraw via **International Bank Transfer** (Razorpay Export)\n• Withdrawals are batched and processed **once per week — every Monday**\n• Funds arrive within **5–7 business days** after the Monday payout batch runs\n• Minimum threshold: **$100 USD** in your Earnings Wallet\n\n⚠️ **Important for international users:** Even if you request a withdrawal on Tuesday, your funds will be queued and processed on the following Monday, then arrive 5–7 business days after that.\n\nManage everything from your **[Wallets](/wallets)** page. 💰`,
  },

  /* ── WALLETS ── */
  {
    patterns: /wallet|deposit|withdraw|add.*fund|fund|money|pay(?:ment)?|transfer|balance/i,
    reply: `Gamerbuddy runs on **two separate wallets** — here's the full breakdown 💸\n\n🔵 **Hiring Wallet** — fund this to hire gamers\n• Deposit via **Razorpay** (UPI, GPay, PhonePe, Paytm, cards…)\n• Min deposit: **$10.75** | Max wallet balance: **$1,000**\n• **Cannot be withdrawn** — only spent on game sessions and tips\n\n🟢 **Earnings Wallet** — where your gamer income lands\n• Earn **90%** of every accepted bid when the session completes (10% platform fee)\n• Withdraw once your balance hits **$100** (₹8,300 for Indian users)\n• 🇮🇳 **Indian users** → withdraw via **UPI** (GPay, PhonePe, Paytm, etc.) — instant or same-day!\n• 🌍 **International users** → weekly Monday batch → Bank Transfer arriving in **5–7 business days**\n\n🔒 The moment a bid is accepted, funds lock into **escrow** — safe and untouchable by either side until the session is done.\n\nHead to **[Wallets](/wallets)** or **[Add Funds](/add-funds)** to get started! 💪`,
  },

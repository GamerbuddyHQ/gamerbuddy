...
const RESPONSES: Array<{ patterns: RegExp; reply: string }> = [
  ...
  {
    patterns: /email.*verif|verif.*email|otp|one.*time.*pass|email.*code|verify.*email|email.*otp|email.*trust/i,
    reply: `📧 **Email Verification** is a quick, optional step that boosts your trust on the platform!\n\n**How it works:**\n1. Go to your **[Profile](/profile)** page\n2. Scroll to the **"Verify Your Email"** card\n3. Click **"Send OTP to my Email"** — a 6-digit code lands in your inbox\n4. Enter the code (valid for 10 minutes)\n5. Done! Your profile shows a green ✅ **Email Verified** badge\n\n**Why bother?**\n• 📈 **+5 Trust Factor** added instantly to your profile\n• 🛡️ Shows hirers you're a real, verified account — not a bot\n• 🔒 Helps prevent fake accounts and keeps the platform safe\n\n**Good to know:**\n• You get **3 attempts** to enter the code before it's invalidated\n• Max **3 OTP requests per hour** — so grab the code quickly!\n• It's completely **optional** — you can skip and verify later\n\nVerifying takes less than 60 seconds and makes your profile noticeably more trustworthy! 🚀`,
  },

  /* ── VERIFICATION / BADGE ── */
  {
    patterns: /verif|badge|trust.*factor|id.*check|how.*long.*verify|green.*tick/i,
    reply: `Verification unlocks posting and bidding on Gamerbuddy — and it's fast! ✅\n\n**How to get verified (~24 hours):**\n1. Go to your **[Profile](/profile)** page\n2. Scroll to **"Gaming Accounts"**\n3. 🎮 Click any platform — **Steam, Epic, PSN, Xbox, or Nintendo Switch**\n4. Enter your username/gamertag and hit **Connect**\n5. Keep that gaming account **Public** so we can verify real activity\n6. We review within **24 hours** → Green badge appears! 🎉\n\n**Also available — Email Verification (optional):**\n• Go to your Profile → scroll to **"Verify Your Email"**\n• Send a 6-digit OTP to your inbox and enter it\n• Get a green **Email Verified** badge + **+5 Trust Factor** instantly! 📧✅\n\n**What each badge means:**\n• 🟡 **Under Review** — gaming account linked, review in progress\n• 🟢 **Gaming Verified** — fully reviewed, trust established\n• ✉️ **Email Verified** — email confirmed via OTP\n\n🌟 **Pro tip:** A full profile with gaming accounts AND email verified gets you **significantly more bids**. Hirers trust complete profiles! 🚀`,
  },

...
export function StreamingAccountsDisplay({ accounts, className = "", onConnect }: Props) {
  ...
  return (
    <div
      ...
      style={{
        borderColor: connectedCount > 0 ? "rgba(161,255,79,0.25)" : "rgba(255,255,255,0.07)",
        background: "rgba(8,6,18,0.75)",
        boxShadow: connectedCount > 0
          ? "0 0 0 1px rgba(161,255,79,0.06), 0 4px 32px rgba(161,255,79,0.08)"
          : "none",
      }}
    >
      {/* ── Header ── */}
        ...
        <div className="flex items-center gap-2.5">
          <span className="relative flex h-2.5 w-2.5">
            <span
              ...
              style={{ background: connectedCount > 0 ? "#A1FF4F" : "#4b5563" }}
            />
            <span
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: "#A1FF4F",
                boxShadow: "0 0 0 0 rgba(161,255,79,0)",
              }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.boxShadow = "0 0 14px rgba(161,255,79,0.3)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.boxShadow = "0 0 0 0 rgba(161,255,79,0)";
              }}
            >

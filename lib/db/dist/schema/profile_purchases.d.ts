export declare const profilePurchasesTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "profile_purchases";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "profile_purchases";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
...
//# sourceMappingURL=profile_purchases.d.ts.map